...
#
#      sh kit/tests/install-the-run.sh
# =============================================================================
set -e
...
<!-- Écrit par kit/tests/install-the-run.sh. Ne pas modifier à la main :
...
<dict>
  ...
  <array>
    <string>$NODE</string>
    <string>$RACINE/kit/tests/night-run.mjs</string>
  </array>
  ...
  <string>$RACINE/kit/tests/banc-de-nuit.launchd.log</string>
...
echo "     launchctl start fr.fili.banc-de-nuit && sleep 5 && tail -f \"$RACINE/kit/tests/banc-de-nuit.launchd.log\""
echo ""
