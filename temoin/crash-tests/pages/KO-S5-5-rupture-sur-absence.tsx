...
export function PageKOS55() {
  return (
    <main>
      <Section densite="ample" data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Titre niveau={1}>Section une</Titre></Section>
