...
const RULES: { id: string; name: string; heading: string; statement: string; why?: string; div?: string; src: { t: string; h: string }[] }[] = [
  ...
  { id: "c2", name: "C2", heading: "Trois registres étanches",
    statement: "La palette se répartit en trois registres — marque, sémantique, neutres — et chaque jeton appartient à exactement un.",
    why: "La marque porte l'identité, la sémantique porte un état, les neutres structurent la page. Trois responsabilités, trois familles, aucun jeton à cheval.",
  ...
  { id: "c4", name: "C4", heading: "Un jeton naît d'un besoin réel",
    statement: "Le registre marque se limite aux rôles fonctionnels existants ; une teinte purement décorative ne reçoit pas de jeton — et un rôle sans consommateur ne reste pas.",
  ...
  { id: "c7", name: "C7", heading: "Le contraste se vérifie par paire",
    statement: "Un jeton de texte n'est jamais conforme dans l'absolu — il l'est sur un fond donné. Chaque jeton de texte déclare ses fonds d'usage ; tout fond non déclaré est interdit.",
  ...
  { id: "c9", name: "C9", heading: "Aucun jeton de texte sous le seuil",
    statement: "Aucun jeton de texte du registre ne descend sous le seuil de lisibilité sur ses fonds déclarés, dans les deux thèmes.",
  ...
  { id: "c10", name: "C10", heading: "Les états sont des jetons, pas des calculs",
    statement: "Les états interactifs sont portés par des jetons dédiés, jamais calculés à la volée dans une feuille de style — ni filtre, ni assombrissement calculé.",
  ...
  { id: "c11", name: "C11", heading: "Le désactivé attend son besoin",
    statement: "L'état désactivé n'a pas de jetons tant qu'aucun composant ne documente un besoin légitime ; le jour venu, le couple complet fond/texte/bordure naît en une seule fois.",
    src: [{ t: "WCAG 1.4.3 — exemption des composants inactifs", h: "https://www.w3.org/WAI/WCAG22/Understanding/contrast-minimum.html" }] },
  { id: "c12", name: "C12", heading: "Un jeton, une valeur par thème",
    statement: "Dans un système à thèmes, chaque jeton de couleur résout une valeur par thème déclaré — c'est la condition d'existence d'un second thème.",
...
const LIST: LineList[] = [
  ...
  { name: "Ni gris pâle, ni voile",
    says: "Le gris le plus clair de la charte ne porte jamais un texte — ici il n'a même pas de jeton. Même histoire avec l'opacité : un texte adouci au voile tombe sous le seuil. La hiérarchie se joue au corps et à la graisse, jamais à la pâleur.",
    or: "dans le code" },
  { name: "La valeur vit dans un seul fichier",
    says: "Aucune couleur en dur dans une interface : toute valeur passe par un jeton, et tous les jetons vivent au même endroit. Une couleur écrite à la main est introuvable au changement de marque.",
    or: "dans le code" },
  { name: "Un jeton naît d'un besoin réel",
    says: "Pas de rôle créé « au cas où ». Un jeton naît avec son premier consommateur, et un rôle qui perd le sien sort du registre.",
  ...
  { name: "Le couple complet dès la naissance",
    ...
    or: "dans le code" },
  { name: "Un jeton, une valeur par thème",
    says: "Le même nom porte une valeur en clair et une en sombre. On ne double jamais un jeton pour faire un thème, et aucun composant ne connaît le thème dans lequel il vit.",
    or: "dans le code" },
  { name: "Le désactivé attend son besoin",
    says: "Aucun jeton d'état désactivé tant qu'aucun composant n'en réclame un. Un gris pâle inventé d'avance finit toujours par porter du texte.",
    or: "nulle part — décision d'Auteur", tone: "author" },
...
const CODE: LineCode[] = [
  ...
  { rule: "Le texte courant",
    ...
    product: "l'encre du thème courant", note: "aucun jeton de texte ne descend sous son seuil, dans aucun thème" },
  { rule: "L'erreur",
  ...
  { rule: "Le survol de l'action", fallback: true,
    ...
    product: "un jeton, pas un calcul", note: "ni filtre ni assombrissement à la volée — un survol calculé n'est vérifiable nulle part" },
          ...
          <section className="gdoc-sec set" id="registry">
            ...
            <div className="gdoc-body">
              ...
              <Bands>
                ...
                <Band level={4} name="Le survol est un jeton" side="jamais un calcul"
                ...
                <Band level={4} name="En sombre, l&apos;action s&apos;éclaircit" side="deux valeurs, un seul nom"
                  says="Le même jeton porte une valeur en clair et une en sombre. Une action forcée à garder sa valeur claire dans le thème sombre s&apos;enfonce dans le fond, et le bouton cesse d&apos;être un bouton."
