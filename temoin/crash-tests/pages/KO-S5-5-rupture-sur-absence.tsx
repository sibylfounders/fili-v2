...
export function PageKOS55() {
  return (
    <main>
      <Section density="ample" data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Heading level={1}>Section une</Heading></Section>
