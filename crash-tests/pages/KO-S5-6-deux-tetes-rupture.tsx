...
export function PageKOS56() {
  return (
    <main>
      <Section densite="ample" tete data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Titre niveau={1}>Section une</Titre></Section>
      <Section densite="compact" tete data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Titre niveau={2}>Section 2</Titre><Texte>Corps 2</Texte></Section>
