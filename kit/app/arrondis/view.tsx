...
const RULES: { id: string; name: string; heading: string; statement: string; src: Src[] }[] = [
  ...
  { id: "a8", name: "8", heading: "Un token déclare ses consommateurs",
    statement: "Chaque token de coin porte au moins un consommateur nommé : le container, la card, la row, la marque, le composant, la pilule.",
    src: [{ t: "RADIUS-UX 1.3.0 — R09", h: "#" }] },
  { id: "a9", name: "9", heading: "L'angle droit n'a pas de token",
...
const LIST: LineList[] = [
  ...
  { name: "Tout coin vient de la chaîne",
    ...
    or: "dans le code" },
  { name: "Un token déclare ses consommateurs",
    says: "Chaque token de coin porte au moins un consommateur nommé. Un cran que rien ne consomme sort du registre.",
    or: "dans le code" },
  { name: "L'angle droit n'a pas de token",
...
const CODE: LineCode[] = [
  ...
  { rule: "L'angle droit", fallback: true,
    ...
    product: "aucun token", note: "rien n'est carré par défaut ici — une racine nulle est une racine, pas un cran" },
