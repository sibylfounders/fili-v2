...
export function PageOKS53() {
  return (
    <main>
      <Section density="ample"><Heading level={1}>Section une</Heading></Section>
      ...
      <Section density="ample" head data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Heading level={2}>Section 5</Heading><Text>Corps 5</Text></Section>
