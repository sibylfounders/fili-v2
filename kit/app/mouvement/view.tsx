...
const RULES: { id: string; name: string; heading: string; statement: string; src: Src[] }[] = [
  ...
  { id: "m3", name: "3", heading: "Chaque durée sait où elle va",
    statement: "Quatre durées, chacune avec son emploi écrit : 100 bouton, survol, appui · 200 menu, infobulle, dépliant · 300 tiroir, fenêtre, panneau · 700 arrivée d'une section au défilement. Une durée employée hors de sa table est une faute, ou une chorégraphie déclarée sur sa ligne.",
...
const CODE: LineCode[] = [
  ...
  { rule: "Un tiroir, une fenêtre, un panneau",
...
const LIST: LineList[] = [
  ...
  { name: "Aucune durée écrite à la main",
    says: "Une transition ou une animation prend un jeton du moteur — ou dit « chorégraphie » sur sa ligne. Le moteur relit toutes les feuilles.",
    or: "dans le code" },
