...
export function PageKOS56() {
  return (
    <main>
      <Section density="ample" head data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Heading level={1}>Section une</Heading></Section>
      <Section density="compact" head data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Heading level={2}>Section 2</Heading><Text>Corps 2</Text></Section>
