...
const PAIRS: [string, string, string, number][] = [
  ...
  ["--text-tertiary", "--bg", "le troisième niveau de texte sur le blanc — l'exception « objets secondaires » est levée depuis le 12 septembre", 4.5],
  ["--text-tertiary", "--surface", "le troisième niveau de texte sur le gris", 4.5],
        ...
        <main className="gdoc-content" id="content">
          ...
          <section className="gdoc-sec set" id="code">
            <div className="gdoc-sec-head">
              ...
              <h2>Les rôles, dans les deux thèmes</h2>
