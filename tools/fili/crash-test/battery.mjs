...
export const FIXTURES = [
  ...
  { id: 'KO-S3-2b', fichier: 'crash-tests/piegees/KO-S3-2b-pas-hors-echelle.tsx',  attendu: 'BLOQUE', sujet: 'S3', quoi: "p-7, pas absent de l'échelle" },
  { id: 'KO-S3-3',  fichier: 'crash-tests/piegees/KO-S3-3-marge-enfant.tsx',       attendu: 'BLOQUE', sujet: 'S3', quoi: 'mt-4 sur un enfant' },
  { id: 'KO-S3-4',  fichier: 'crash-tests/piegees/KO-S3-4-marge-section.tsx',      attendu: 'BLOQUE', sujet: 'S3', quoi: 'mb-8 sur une section' },
  { id: 'KO-S3-5',  fichier: 'crash-tests/piegees/KO-S3-5-marge-negative.tsx',     attendu: 'BLOQUE', sujet: 'S3', quoi: '-mt-6 de compensation' },
  ...
  { id: 'OK-S3-1', fichier: 'crash-tests/conformes/OK-S3-1-conteneur-distribue.tsx', attendu: 'PASSE', sujet: 'S3', quoi: 'gap-6 porté par le parent' },
  { id: 'OK-S3-2', fichier: 'crash-tests/conformes/OK-S3-2-pas-de-l-echelle.tsx',    attendu: 'PASSE', sujet: 'S3', quoi: "p-8, pas de l'échelle" },
  ...
  { id: 'KO-S3-12', fichier: 'crash-tests/piegees/KO-S3-12-proximite-prop.tsx',  attendu: 'BLOQUE', sujet: 'S3', quoi: 'groupes à 16 px, intérieur à 8 px' },
  { id: 'KO-S3-13', fichier: 'crash-tests/piegees/KO-S3-13-proximite-classe.tsx',attendu: 'BLOQUE', sujet: 'S3', quoi: 'gap-4 autour de gap-2' },
  { id: 'OK-S3-6', fichier: 'crash-tests/pages/Temoin.tsx',                                    attendu: 'PASSE', sujet: 'S3', quoi: "l'Écran Témoin lui-même" },
  { id: 'OK-S3-7', fichier: 'crash-tests/conformes/OK-S3-7-proximite-tenue.tsx',     attendu: 'PASSE', sujet: 'S3', quoi: 'groupes à 24 px, intérieur à 4 px' },
