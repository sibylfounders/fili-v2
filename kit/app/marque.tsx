...
export function Marque() {
  ...
  if (ici) return <span className="chrome-marque" aria-current="page">{dedans}</span>;
  return <Link className="chrome-marque" href="/" title="Revenir à l'accueil">{dedans}</Link>;
}
