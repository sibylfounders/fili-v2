export function Navigation({ actif }: { actif: "accueil" | "rythme" | "typo" | "couleur" }) {
  return (
    <aside className="navigation">
      ...
      <span className="venir">Arrondis · Tactile · Bordures · Composition — écrites, en attente d&apos;entrée</span>
