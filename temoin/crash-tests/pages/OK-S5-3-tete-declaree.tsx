...
export function PageOKS53() {
  return (
    <main>
      ...
      <Section densite="ample" tete data-intent="statement" data-intent-reason="longue approche : cette page installe son contexte avant de trancher"><Titre niveau={2}>Section 5</Titre><Texte>Corps 5</Texte></Section>
