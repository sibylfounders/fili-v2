...
**Total porté et actif : 29 assertions.** Batterie : 80 fixtures à 100 %.
Mutations : 46 sabotages sur 46 produisent l'écart attendu, mesurés le 7 août.
Contrôle d'intégrité : 29/29.
...
|---|---|---|---|
| É1 · Le verdict | P1 · Prononcer le verdict | 🟡 | 2026-08-07 · 4 états · séance non tenue |
...
|---|---|---|---|
| Les entrées #001 à #042 du journal | 🟢 | `#049` | Perte actée, non reconstruite. Le trou est la trace. |
...
| `claude/journal.md` | projet | Archive gelée des entrées `#043` à `#049`. |
